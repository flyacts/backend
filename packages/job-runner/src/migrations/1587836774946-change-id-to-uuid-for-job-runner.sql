...
ALTER TABLE public.jobs RENAME uuid_job_queue_id TO job_queue_id;
...
ALTER TABLE public.jobs DROP CONSTRAINT IF EXISTS fk___jobs___job_queue_id___job_queue;
ALTER TABLE public.jobs ADD CONSTRAINT fk___jobs___job_queue_id___job_queue FOREIGN KEY (job_queue_id)
